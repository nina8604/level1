...
<body>
<form action="" method="post" enctype = 'multipart/form-data' onsubmit="return checkForm(event)">
    ...
    <fieldset>
        ...
        <div id="phone_container">
            <label for="phone0" >Телефон </label><input id="phone0" class="phones" type="text" data-validate="0" placeholder="+380(xx)xxx-x-xxx">
            <span class="error"> </span>
            <br><br>
        </div>

        <input id="plus" type="button" name="plus" value="Добавить телефон"><br><br><br>
